...
const FeatureProjects = ({ type, title, summary, img, link, github }) => {
  return (
    ...
    rounded-3xl border border-solid border-dark bg-light dark:bg-dark dark:border-light shadow-2xl p-12 relative
    lg:flex-col lg:p-8 xs:radius-2xl xs:rounded-br-3xl xs:p-4
    "
    >
...
const Projects = ({ type, title, summary, img, link, github }) => {
  return (
    ...
    rounded-3xl border border-solid border-dark bg-light dark:bg-dark dark:border-light shadow-2xl p-6 relative
    xs:p-4
    "
    >
      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          ...
          <div className="grid grid-col-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            ...
            <div className="col-span-6 sm:col-span-12sm:col-span-12"><Projects
                title={"iNoteBook web Application"}
                img={iNoteBook}
            //     summary="A iNoteBook web Application using React, Bootstrap CSS, MongoDb, ExpressJs and NodeJs. 
            // You can create note with that title and description that notes will stored on cloud with security notes can be accessed by only you."
